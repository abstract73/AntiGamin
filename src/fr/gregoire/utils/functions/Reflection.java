...
public final class Reflection {
    ...
    public static Class<?> getMinecraftClass(String name) {
        return Reflection.getCanonicalClass(String.valueOf(String.valueOf(NMS_PREFIX)) + "." + name);
    }

    public static Class<?> getCraftBukkitClass(String name) {
        return Reflection.getCanonicalClass(String.valueOf(String.valueOf(OBC_PREFIX)) + "." + name);
    }
